...
<body class="hold-transition login-page bg-green">
  <div class="login-box">
    <div class="login-logo">
      <a href="../"><b>SGE</b>Login</a><br>
      <small style="text-align: center;font-size:50% !important"><b>SGE - Sistema Gerenciador de Escolas</b></small>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
      ...
      <form method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-xs-12">
            <button name="submit" value="submit" type="submit" class="btn btn-success btn-block btn-flat">Entrar</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
