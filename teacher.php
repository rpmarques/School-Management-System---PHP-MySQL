...
<head>
  ...
  <title>SGE - Sistema Gerenciador de Escolas - Professores</title>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Professores</a></li>
                ...
                <form role="form" method="POST">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input name="email" type="email" class="form-control" id="exampleInputPassword1" placeholder="exemplo@exemplo.com.br" required>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="exampleFormControlTextarea1">Matérias</label>
              ...
              <div class="box box-primary">
                ...
                <form role="form" method="POST">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="exampleInputPassword1">Conato</label>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    if ($result->num_rows > 0) {
                      // output data of each row
                      while ($row = $result->fetch_assoc()) {
                        echo "<tr><td> " . $row["tid"] . " </td><td> " . $row["fname"] . " " . $row["lname"] . " </td><td> " . $row["bday"] . "</td><td>" . $row["gender"] . "</td><td>" . $row["address"] . "</td><td>" . $row["contact"] . "</td><td>" . $row["skill"] . "</td><td><a href='teacher.php?update=" . $row["tid"] . "'><small class='label  bg-orange'>Editar</small></a></td></tr>";
                      }
                    }
                    ?>
                  </tbody>
