...
<head>
  ...
  <title>SGE - Sistema Gerenciador de Escolas - Agenda </title>
              ...
              <form role="form" method="POST">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" name="day">
                      <option>Selecinoe</option>
                      <option value="Monday">Segunda-Feira</option>
                      <option value="Tuesday">Terça-Feira</option>
                      <option value="Wendsday">Quarta-Feira</option>
