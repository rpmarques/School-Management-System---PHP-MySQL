...
<head>
  ...
  <title>SGE - Sistema Gerenciador de Escolas - Matérias </title>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Matérias</a></li>
            ...
            <div class="col-xs-4">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Nova Matéria</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="POST">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input name="sid" type="text" class="form-control" id="exampleInputPassword1" placeholder="" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Título</label>
                      <input name="title" type="text" class="form-control" id="exampleInputPassword1" placeholder="Título do Recado" required>
                    </div>
                    <div class="form-group">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    if ($result->num_rows > 0) {
                      // output data of each row
                      while ($row = $result->fetch_assoc()) {
                        echo "<tr><td> " . $row["sid"] . " </td><td> " . $row["title"] . "</td><td>" . $row["description"] . "</td><td><a href='subject.php?update=" . $row["sid"] . "'><small class='label  bg-orange'>Editar</small></a></td></tr>";
                      }
                    }
                    ?>
                  </tbody>
